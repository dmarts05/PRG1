...
public class Apartado030202 extends Apartado {
	...
	public void ejercicio01() {
		...
		while (contador < 10) {
			System.out.println("Introduce un numero para la serie: ");
	...
	public void ejercicio05() {
		...
		// Inicio modificacion
		NumeroEntero numero = new NumeroEntero(543);
		System.out.println("Numero de digitos: " + numero.numeroDigitos());
		System.out.println("Inverso: " + numero.inverso());
		System.out.println("Es capicua: " + numero.esCapicua());
        // Fin modificacion
	}
