 ...
 */
    ...
    */
      ...
      // Inicio modificacion
         System.out.println(cadena.append(logica));
         System.out.println(cadena.append(otraCadena));
         System.out.println(cadena.append(anyo));
        // Fin modificacion
      }
    ...
    */
       public void ejercicio03() {
         ...
         StringBuffer cadena=new StringBuffer("Viaje al Parnaso");
         String parnaso = "Parnaso";
         int indexParnaso = cadena.indexOf(parnaso); 
      // Modificaciones
         cadena.replace(indexParnaso, indexParnaso + parnaso.length(), "Castalia");
         cadena.deleteCharAt(cadena.indexOf("l"));
         System.out.println(cadena.toString());
      }
    ...
    */
       public void ejercicio05() {
		...
		//modificaciones
      int indexViaje = cadena.indexOf("Viaje");
      String viaje = "Viaje"; 
      cadena.replace(indexViaje, indexViaje + viaje.length(), otraCadena);
