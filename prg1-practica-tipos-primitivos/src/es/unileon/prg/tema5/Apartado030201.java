 ...
 */
    ...
    */
       public void ejercicio01() {
        ...
        // Inicio modificacion
         ...
         int cadenaMitad = cadenaLen / 2;
         char caracterIntermedio = cadena.charAt(cadenaMitad);
         System.out.println("Caracter: " + caracterIntermedio + "\nCodigo ASCII: " + (int) caracterIntermedio);
        // Fin modificacion
      }
    ...
    */
      ...
      // Inicio modificacion
         ...
         System.out.println(cadena.toLowerCase().equals(otraCadena.toLowerCase()));
      // Fin modificacion
      }
    ...
    */
       public void ejercicio05() {
         ...
         String cadena = "Viaje al Parnaso";
      // Inicio modificacion
         System.out.println(cadena.indexOf('p') >= 0);
         System.out.println(cadena.indexOf("Par") >= 0);
    ...
    */
       public void ejercicio07() {
         ...
         String cadena = "Viaje al Parnaso";
         int cadenaLen = cadena.length();
         System.out.println(cadena.substring(cadenaLen / 2));
         System.out.println(cadena.substring(cadena.indexOf('j'), cadena.indexOf('s')));
      // Inicio modificacion
        // Fin modificacion
      }
