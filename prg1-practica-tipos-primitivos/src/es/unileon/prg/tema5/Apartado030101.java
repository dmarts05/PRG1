...
public class Apartado030101 extends Apartado {
	...
	public void ejercicio01() {
		...
		byte enteroDe8Bits = 100; // Se debe reducir 10000 hasta que entre en el rango del byte [-128 -127]
		char caracter = 'a';
		char otroCaracter = 'a';
		boolean booleano = true;
		short enteroDe16Bits = 5000; // Se debe reducir 50000 hasta que entre en el rango del short [-32768 - 32767]

		byte staticVariable = 5; // No se puede crear una variable con la palabra reservada static 
		byte intVariable = 3; // No se puede crear una variable con la palabra reservada int
	...
	public void ejercicio03() {
		...
		byte asignaturasCurso = 0; //Numero de asignaturas de un curso
		float notaMedia = 0.0f; //Nota media de la asignatura
		byte edadPersona = 0; //Edad de una persona
		float salarioMensual = 0.0f; //Salario mensual de un empleado
		String nombreAsignatura = ""; //Nombre de una asignatura
		final float PI = 3.1416f; //Constante PI
		final boolean VERDADERO = true; //Constante VERDADERO
		short portalVivienda = 0; //Portal de la direccion de una vivienda
		byte pisoVivienda = 0; //Piso de la direccion de una vivienda
		char puertaVivienda = 'A'; //Puerta de la direccion de una vivienda
